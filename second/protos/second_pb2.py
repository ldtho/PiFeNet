...
_VOXELNET_VOXELFEATUREEXTRACTOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='boost_channel_dim', full_name='second.protos.VoxelNet.VoxelFeatureExtractor.boost_channel_dim', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='reduction_rate', full_name='second.protos.VoxelNet.VoxelFeatureExtractor.reduction_rate', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='use_paca_weight', full_name='second.protos.VoxelNet.VoxelFeatureExtractor.use_paca_weight', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='num_point_per_voxel', full_name='second.protos.VoxelNet.VoxelFeatureExtractor.num_point_per_voxel', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='channel_att', full_name='second.protos.VoxelNet.VoxelFeatureExtractor.channel_att', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='point_att', full_name='second.protos.VoxelNet.VoxelFeatureExtractor.point_att', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='task_aware_att', full_name='second.protos.VoxelNet.VoxelFeatureExtractor.task_aware_att', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pool_types', full_name='second.protos.VoxelNet.VoxelFeatureExtractor.pool_types', index=11,
...
_VOXELNET_RPN = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='heads', full_name='second.protos.VoxelNet.RPN.heads', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cca', full_name='second.protos.VoxelNet.RPN.cca', index=10,
      number=11, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mhsa', full_name='second.protos.VoxelNet.RPN.mhsa', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='load_resnet_weight', full_name='second.protos.VoxelNet.RPN.load_resnet_weight', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mhsa_refine', full_name='second.protos.VoxelNet.RPN.mhsa_refine', index=13,
